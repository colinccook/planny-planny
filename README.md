...
- **Subtle Sound Effects** — Friendly little Web Audio chimes when meals or todos arrive, when reactions land, when you tick a task off, and as you swipe between days (in time with the slide animation). On by default; if you find them distracting you can switch them off in Settings → Preferences and the choice follows you across devices.
