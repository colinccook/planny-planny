        ...
        >
          <div className="flex items-center justify-between">
            ...
            <select
              ...
              className="min-h-[44px] rounded-md border border-gray-300 py-2 pl-3 pr-8 text-base focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
            >
