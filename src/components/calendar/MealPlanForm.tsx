      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full rounded-md border border-gray-300 px-3 py-2 text-base placeholder:text-gray-400 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none"
            autoFocus
            required
          />
        </div>
